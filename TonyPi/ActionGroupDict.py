#!/usr/bin/python3
# coding=utf8
# dictionary mapping app calls to corresponding actions: Left side represents app calls, right side represents actual corresponding actions
# In the app:
#   long-press to enter custom mode
#   then fill in the action name and number. The number corresponds to the left side, and the name can be freely chosen
