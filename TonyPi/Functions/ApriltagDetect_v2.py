...
def apriltagDetect(img):   
    ...
    if len(detections) != 0:
        for detection in detections:                       
            corners = np.int0(detection.corners)  # get four corner points
            ...
            print(f'object_center_x:{object_center_x} , object_center_y:{object_center_y} , object_angle:{object_angle}')
            return tag_family, tag_id
            
    return None, None


def runAprilTagDetection(img):
    global tag_id
    global action_finish
...
if __name__ == '__main__':
    ...
    while True:
        ...
        if ret:
            ...
            Frame = runAprilTagDetection(frame)           
